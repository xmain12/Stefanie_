...
Asena.addCommand({pattern: 'search', fromMe: false, desc: FIND_DESC }, (async (message, match) => {
    if (message.reply_message === false) return await message.client.sendMessage(message.jid, '*අනිවාර්යයෙන් ඔබ mp3 එකකට reply දැමිය යුතුයි⚡Stefanie!*', MessageType.text);
