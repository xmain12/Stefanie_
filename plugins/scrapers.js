...
if (config.WORKTYPE == 'private') {
    ...
    WhatsAlexa.addCommand({pattern: 'song ?(.*)', fromMe: true, desc: Lang.SONG_DESC}, (async (message, match) => { 
        ...
        var reply = await message.client.sendMessage(message.jid,Config.DOWNLOAD_SONG,MessageType.text);
    ...
    WhatsAlexa.addCommand({pattern: 'video ?(.*)', fromMe: true, desc: Lang.VIDEO_DESC}, (async (message, match) => { 
        ...
        var reply = await message.client.sendMessage(message.jid,Config.DOWNLOAD_VIDEO,MessageType.text);
        ...
        yt.on('end', async () => {
            reply = await message.client.sendMessage(message.jid,Config.UPLOAD_VIDEO,MessageType.text);
