...
if (config.WORKTYPE == 'private') {
    ...
    WhatsAlexa.addCommand({pattern: 'song ?(.*)', fromMe: true, desc: Lang.SONG_DESC}, (async (message, match) => { 
        ...
        var reply = await message.client.sendMessage(message.jid,Config.SON_DG,MessageType.text);
    ...
    WhatsAlexa.addCommand({pattern: 'play ?(.*)', fromMe: true, desc: Lang.PLAY_DESC}, (async (message, match) => { 
        ...
        arama = arama.all;
        if(arama.length < 1) return await message.client.sendMessage(message.jid,Lang.NO_RESULT,MessageType.text);
        var reply = await message.client.sendMessage(message.jid,Config.PLY_GD,MessageType.text);
    ...
    WhatsAlexa.addCommand({pattern: 'video ?(.*)', fromMe: true, desc: Lang.VIDEO_DESC}, (async (message, match) => { 
        ...
        var reply = await message.client.sendMessage(message.jid,Config.VID_GD,MessageType.text);
        ...
        yt.on('end', async () => {
            reply = await message.client.sendMessage(message.jid,Config.VID_GU,MessageType.text);
    ...
    WhatsAlexa.addCommand({pattern: 'song ?(.*)', fromMe: false, desc: Lang.SONG_DESC}, (async (message, match) => { 
        ...
        arama = arama.all;
        if(arama.length < 1) return await message.client.sendMessage(message.jid,Lang.NO_RESULT,MessageType.text);
        var reply = await message.client.sendMessage(message.jid,Config.SON_GD,MessageType.text);
