...
if (Config.WORKTYPE == 'private') {
  ...
  var topText, bottomText;
    ...
    var webimage = await axios.get(`https://api.zeks.xyz/api/matrix?apikey=bY17wlPg4XQvRQkJRqXjPPipPd2&text=${encodeURIComponent(match[1])}&text2=manoj`, { responseType: 'arraybuffer' })
   ...
   await message.client.sendMessage(message.jid,Buffer.from(webimage.data), MessageType.image, {mimetype: Mimetype.jpg, caption: 'Made by WhatsAsenaPublic'})
    ...
    var webimage = await axios.get(`https://api.zeks.xyz/api/splaybutton?apikey=bY17wlPg4XQvRQkJRqXjPPipPd2&text=${encodeURIComponent(match[1])}&text2=manoj`, { responseType: 'arraybuffer' })
