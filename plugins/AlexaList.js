...
if (Config.WORKTYPE == 'private') {
    ...
    WhatsAlexa.addCommand({pattern: 'panel ?(.*)', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    WhatsAlexa.addCommand({pattern: 'panel ?(.*)', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
