                ...
                if ((command.on !== undefined && (command.on === 'image' || command.on === 'photo')
                    ...
                    if (sendMsg) {
                        ...
                        try {
                            ...
                            if (config.LANG == 'EN') {
                                await conn.sendMessage(conn.user.jid, fs.readFileSync("./src/image/whatsapp.jpg"), MessageType.image, { caption: '*『 ERROR 』*\n\n*Stefanie an error has occurred!*\n_Report this error to the developer! [ Kaweesha Chamod ]._\n\n*Error:* ```' + error + '```\n\n' });
