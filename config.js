...
module.exports = {
    ...
    SONGD: process.env.SONGD === undefined ? 'ᴅᴏᴡɴʟᴏᴀᴅɪɴ�? ꜱᴏɴɢ' : process.env.SONGD,
    SONGU: process.env.SONGU === undefined ? 'ᴜᴘʟᴏᴀᴅɪɴ�? ꜱᴏɴɢ' : process.env.SONGU,
    ...
    GIT: 'https://github.com/Kaweeshachamodk/stefanie',
    HEROKU: {
