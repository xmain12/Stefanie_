...
module.exports = {
    ...
    ALIVE_LOGO: process.env.ALIVE_LOGO === undefined ? 'https://telegra.ph/file/fbb8f75bf5f7f477ff92d.jpg' : process.env.ALIVE_LOGO,
    ...
    SUDO: process.env.SUDO === undefined ? ',0,' : process.env.SUDO,
    DEBUG: DEBUG,
