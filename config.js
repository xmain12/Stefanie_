...
module.exports = {
    ...
    STEFANIE_FILTER: process.env.STEFANIE_FILTER === undefined ? 'true' : process.env.STEFANIE_FILTER,
    ...
    ANTI_BLOCK: process.env.ANTI_BLOCK === undefined ?'false' : process.env.ANTI_BLOCK,
