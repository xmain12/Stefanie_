...
module.exports = {
    ...
    DOWNLOAD_SONG: process.env.DOWNLOAD_SONG === undefined ? '```Downloading your song...```' : process.env.DOWNLOAD_SONG,
    DOWNLOAD_VIDEO: process.env.DOWNLOAD_VIDEO === undefined ? '```Downloading your video...```' : process.env.DOWNLOAD_VIDEO,
    UPLOAD_VIDEO: process.env.UPLOAD_VIDEO === undefined ? '```Uploading your video```' : process.env.UPLOAD_VIDEO,
